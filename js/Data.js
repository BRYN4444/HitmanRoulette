...
var ths = {
	...
	"Secret Tunnel|Shamen. Idol. Open. Path. Knife.|path.jpg",
	...
	contractWild: ["Secret Tunnel|Shamen. Idol. Open. Path. Knife.|path.jpg",
	"Cog In The Machine|Recover Franco's missing circuit board.",
	"Feedin' Time|Make the hippo feel better.",
	"Don't Shoot The Messenger|Find Héctor Delgado's love letter.",
	"Salt The Earth|Destroy Franco's rare flower sample.",
...
var tf = {
	...
	"Pirro Salazar|Party goer talking to a relative and awaiting the Asado feast.",
	"Augusto Albarez|Party goer awaiting the Asado feast.",
	"Fletcher Fernansez|Party goer awaiting the Asado feast.",
	"Alex Rheinhart|On their cell, awaiting the Asado feast.",
	"Shaun McGee|On their cell, awaiting the Asado feast.",
	"Natasha Jones|Party goer wandering among the attendees near the Asado pit.",
	...
	"Archie Riley|Party goer with knowledge of Tamara Vidal. Talking at the northern railing away from the Asado area. (Level 3)",
	...
	"Elizabeth Fritz|Party goer that uses the stairs between the Asado area and Tasting Room.",
	"Christoffer Feldtmann|Party goer that uses the stairs between the Asado area and Tasting Room.",
	...
	"Samuel Cooke|Party goer taking a smoke in the Parking Lot.",
	"Megan Mcdonald|Party goer currently on the Dance Floor.",
	"Tommy Hamilton|Party goer getting too drunk off the wine. Leaves the Tasting Room to vomit.",
	...
	"Caleb Woods|Party Goer drinking wine in the Tasting Room.",
	"Kieran Simmons|Party Goer drinking wine in the Tasting Room.",
	"Finley Reynolds|Party Goer drinking wine in the Tasting Room.",
	"Andrew Harrison|Party Goer drinking wine in the Tasting Room.",
	"Charlee Ball|Party Goer drinking wine in the Tasting Room.",
	"Chaya Zetticcia|Waiter working in the Tasting Room.",
	"Brooklyn Bush|Party Goer just outside the Tasting Room.",
	"Jonah Sherman|Party Goer just outside the Tasting Room.",
	...
	"James Robertson|Party goer using the Bathroom next to Reception.",
	...
	"Joseph Byrne|Party goer on the far stairs leading to a platform hanging over the Grapefield.",
...
var untouchable = {
	...
	disguises: ["Subject 47","Office Staff","Providence Commando","Providence Commando Leader","Providence Doctor","Providence Elite Guard","Providence Security Guard","Providence Security Guard (Suit)"],
	wild: ["The Gun Muffler|Construct a silencer",
	"Exhibition Shooting|Shoot a train signal."],
	contractWild: ["The Gun Muffler|Construct a silencer",
	"Exhibition Shooting|Shoot a train signal."],
	photos: ["Photographic Proof|Take a photo of your target(s) after you've eliminated them, unless their body is unavailable.<br /><br />They must not be in a body bag."]
};
