...
var al = {
	...
	exit: ["Bus Stop","Bridge","Raft|(Needs Paddle)","Manhole|(Needs Crowbar)","Construction Van|(Needs Key)","Trash Truck|(Garbage Man Only)","Roadwork Gate|(Needs Key)"],
	eexit: ["Bus Stop","Bridge","Raft|(Needs Paddle)","Manhole|(Needs Crowbar)","Construction Van|(Needs Key)","Trash Truck|(Garbage Man Only)","Roadwork Gate|(Needs Key)"],
	disguises: ["Any Suit",
	"Arkian Robe",
	"BBQ Owner",
	"Cassidy Bodyguard",
...
var ap = {
	...
	"Agent Swan|ICA Agent patroling for you throughout the Chill Out and Juice Bar areas.",
	...
	"Agent Lowenthal|ICA Agent disguised as a Biker, patroling for you throughout the Biker's building. (Level 0)",
