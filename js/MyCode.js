...
$(document).ready(function() {
	/******Latest Updates******/
	$("#features p#title").text("Last Updated: Sept 26th, 2025"); /*Roulette Features*/
	$("#features .updatenotes").html('Added an Elusive Target: The Infiltrator. See <b><a href="https://github.com/BRYN4444/HitmanRoulette#latest-update" target="_blank">Github</a></b> for info.');
