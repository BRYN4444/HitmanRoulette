...
$(document).ready(function() {
	/******Latest Updates******/
	$("#features p#title").text("Last Updated: July 20th, 2024"); /*Roulette Features*/
	$("#features .updatenotes").html('Added an Elusive Target: The Disruptor (2024). <b><a href="https://github.com/BRYN4444/HitmanRoulette#latest-update" target="_blank">Github</a></b> for info.');
