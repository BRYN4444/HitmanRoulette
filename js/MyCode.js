...
$(document).ready(function() {
	/******Latest Updates******/
	$("#features p#title").text("Last Updated: Feb. 28th, 2026"); /*Roulette Features*/
	$("#features .updatenotes").html('Added an Elusive Target: The Harbinger. See <b><a href="https://github.com/BRYN4444/HitmanRoulette#latest-update" target="_blank">Github</a></b> for info.');
